...
public class pathToTrajectory {
  // public static PathPlannerTrajectory covertPathToTrajectory(PathPlannerPath path, ChassisSpeeds
  // startSpeeds, Rotation2d startRotation){
  //     PathPlannerTrajectory traj = path.generateTrajectory(startSpeeds, startRotation,
