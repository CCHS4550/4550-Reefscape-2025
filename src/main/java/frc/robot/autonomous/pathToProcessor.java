...
public class pathToProcessor {
  public static PathPlannerPath goToProccessor() {
    Pose2d bluePose2d = new Pose2d(); // with the actual processor location
    Pose2d redPose2d = new Pose2d();
    Pose2d targetPose;
    if (DriverStation.getAlliance().equals(DriverStation.Alliance.Blue)) {
        targetPose = bluePose2d;
      } else {
        targetPose = redPose2d;
      }
